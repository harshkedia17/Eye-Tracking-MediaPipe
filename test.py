    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            utils.colorBackgroundText(
                frame, f'R: {eye_position}', FONTS, 1.0, (40, 220), 2, color[0], color[1], 8, 8)
            eye_position_left, color = positionEstimator(crop_left)
            utils.colorBackgroundText(
                frame, f'L: {eye_position_left}', FONTS, 1.0, (40, 320), 2, color[0], color[1], 8, 8)
            if eye_position != "CENTER" and eye_position_left != "CENTER":
                utils.colorBackgroundText(frame,  f'You are looking somewhere else!!', FONTS, 0.7, (int(
